...
## 🧾 GitHub + Resume Readiness

To keep this project looking like real engineering work (not throwaway auto-generated output), this repository emphasizes:

- Explicit decision logs tied to domain constraints.
- Unit tests for critical leakage-prone steps (RUL, sequences, splits).
- Reproducible CLI pipeline with safe defaults and auditable reports.
- MLflow experiment lineage with parameterized runs.

See `docs/portfolio_readiness.md` for a publishing checklist and resume bullets.
